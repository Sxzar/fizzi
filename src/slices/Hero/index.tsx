...
import HeroClientAnimationWrapper from './HeroClientAnimationWrapper';
import HeroVisualSceneWrapper from './HeroVisualSceneWrapper';
...
const Hero: FC<HeroProps> = ({ slice }) => {
    return (
        ...
        >
            <HeroClientAnimationWrapper />
            <HeroVisualSceneWrapper />
